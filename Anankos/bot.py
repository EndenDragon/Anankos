...
class Anankos(discord.Client):
    def __init__(self, config):
        ...
        self.image_embed = ImageEmbed(self, config.get("imageembed_channelids", []), config.get("twitter_consumer_key"), config.get("twitter_consumer_secret"), config.get("twitter_access_token_key"), config.get("twitter_access_token_secret"))
